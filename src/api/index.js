...
export const fetchWorldwideData = () => {
  ...
  // comment this return statement in order to run app when service is down and it fails to fetch data
  return fetchData("https://api.covid19api.com/summary", headers);

  // uncomment this return inorder to run app by fetching dummy data when service is down
...
export const fetchCountries = () => {
  // comment this return statement in order to run app when service is down and it fails to fetch data
  return fetchData("https://api.covid19api.com/countries");
...
export const fetchLiveByCountry = (country) => {
  // comment this return statement in order to run app when service is down and it fails to fetch data
  return fetchData(
